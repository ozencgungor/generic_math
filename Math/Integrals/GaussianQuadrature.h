...
private:
    static std::vector<double> getAbscissas(size_t order) {
        switch (order) {
            ...
            case 4:
                return {-0.8611363115940526, -0.3399810435848563, 0.3399810435848563,
                        0.8611363115940526};
            case 5:
                return {-0.9061798459386640, -0.5384693101056831, 0.0, 0.5384693101056831,
                        0.9061798459386640};
            case 6:
            ...
            default:
                throw std::invalid_argument("Gauss-Legendre order " + std::to_string(order) +
                                            " not implemented");
        }
    }
    ...
    static std::vector<double> getWeights(size_t order) {
        switch (order) {
            ...
            case 4:
                return {0.3478548451374538, 0.6521451548625461, 0.6521451548625461,
                        0.3478548451374538};
            case 5:
