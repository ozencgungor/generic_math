...
public:
    ...
    Integrator(double absoluteAccuracy, size_t maxEvaluations)
        : m_absoluteAccuracy(absoluteAccuracy), m_maxEvaluations(maxEvaluations),
          m_absoluteError(0.0), m_evaluations(0) {}
    ...
    virtual bool integrationSuccess() const { return m_absoluteError <= m_absoluteAccuracy; }
