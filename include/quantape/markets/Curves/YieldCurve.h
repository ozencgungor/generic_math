...
#include "quantape/markets/Descriptors/YieldCurveDescriptor.h"
...
public:
    ...
    YieldCurve(const ContainerT& tenors, const ContainerT& zeroRates,
        ...
        m_interpolator = std::make_unique<quantape::math::CubicInterpolation<DoubleT>>(
            m_tenors, m_zeroRates, quantape::math::CubicDerivativeApprox::Spline);
    }
...
private:
    ...
    std::unique_ptr<quantape::math::CubicInterpolation<DoubleT>> m_interpolator;
