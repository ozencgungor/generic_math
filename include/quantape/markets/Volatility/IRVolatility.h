...
#include "quantape/markets/Descriptors/IRVolDescriptor.h"
...
public:
    ...
    IRVolatility(const VectorT& expiries, const VectorT& tenors, const SurfaceT& atmVolSurface,
        ...
        m_atmInterpolator = std::make_unique<quantape::math::BicubicInterpolation<DoubleT>>(
            m_tenors, m_expiries, m_atmVolSurface, quantape::math::CubicDerivativeApprox::Spline);
    }
...
private:
    ...
    std::unique_ptr<quantape::math::BicubicInterpolation<DoubleT>> m_atmInterpolator;
