...
public:
    ...
    EQDVolatility(const VectorT& expiries, const VectorT& strikes, const SurfaceT& volSurface,
        ...
        m_interpolator = std::make_unique<quantape::math::BicubicInterpolation<DoubleT>>(
            m_strikes, m_expiries, m_volSurface, quantape::math::CubicDerivativeApprox::Spline);
    }
...
private:
    ...
    std::unique_ptr<quantape::math::BicubicInterpolation<DoubleT>> m_interpolator;
