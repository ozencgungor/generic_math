...
//
//   1. the integrator is re-run on quantape::math::detail::RuleScalar — a probe scalar that
...
struct RuleScalar {
    ...
    [[noreturn]] static void nonlinear() {
        throw std::logic_error(
            "quantape::math::detail::RuleScalar: integrator combination is nonlinear in the "
            "f-evaluations; "
...
inline stan::math::var TrapezoidIntegrator<stan::math::var, DefaultPolicy>::integratePrimitives(
    ...
    TrapezoidIntegrator<quantape::math::detail::RuleScalar, DefaultPolicy> rule(
        this->absoluteAccuracy(), this->maxEvaluations());
    const stan::math::var result =
        quantape::math::detail::integrateWithRule<stan::math::var>(rule, f, a, b);
...
TrapezoidIntegrator<stan::math::fvar<stan::math::var>, DefaultPolicy>::integratePrimitives(
    ...
    TrapezoidIntegrator<quantape::math::detail::RuleScalar, DefaultPolicy> rule(
        this->absoluteAccuracy(), this->maxEvaluations());
    const fvv result = quantape::math::detail::integrateWithRule<fvv>(rule, f, a, b);
    this->setNumberOfEvaluations(rule.numberOfEvaluations());
    this->setAbsoluteError(rule.absoluteError());
    return result;
}
...
inline stan::math::var TrapezoidIntegrator<stan::math::var, MidPointPolicy>::integratePrimitives(
    const FunctionType& f, stan::math::var a, stan::math::var b) const {
    TrapezoidIntegrator<quantape::math::detail::RuleScalar, MidPointPolicy> rule(
        this->absoluteAccuracy(), this->maxEvaluations());
    const stan::math::var result =
        quantape::math::detail::integrateWithRule<stan::math::var>(rule, f, a, b);
    this->setNumberOfEvaluations(rule.numberOfEvaluations());
...
SimpsonIntegrator<stan::math::var>::integratePrimitives(const FunctionType& f, stan::math::var a,
    ...
    SimpsonIntegrator<quantape::math::detail::RuleScalar> rule(this->absoluteAccuracy(),
                                                               this->maxEvaluations());
    const stan::math::var result =
        quantape::math::detail::integrateWithRule<stan::math::var>(rule, f, a, b);
    this->setNumberOfEvaluations(rule.numberOfEvaluations());
...
inline stan::math::var GaussLobattoIntegrator<stan::math::var>::integratePrimitives(
    const FunctionType& f, stan::math::var a, stan::math::var b) const {
    GaussLobattoIntegrator<quantape::math::detail::RuleScalar> rule(
...
inline stan::math::var GaussLegendreIntegrator<stan::math::var>::integratePrimitives(
    const FunctionType& f, stan::math::var a, stan::math::var b) const {
    GaussLegendreIntegrator<quantape::math::detail::RuleScalar> rule(m_quadrature.order());
    const stan::math::var result =
        quantape::math::detail::integrateWithRule<stan::math::var>(rule, f, a, b);
    this->setNumberOfEvaluations(rule.numberOfEvaluations());
    this->setAbsoluteError(rule.absoluteError());
...
TanhSinhIntegrator<stan::math::var>::integratePrimitives(const FunctionType& f, stan::math::var a,
                                                         stan::math::var b) const {
    TanhSinhIntegrator<quantape::math::detail::RuleScalar> rule(
        this->absoluteAccuracy(), this->maxEvaluations(), m_relAccuracy, m_minLevels, m_maxLevels);
    const stan::math::var result =
        quantape::math::detail::integrateWithRule<stan::math::var>(rule, f, a, b);
    this->setNumberOfEvaluations(rule.numberOfEvaluations());
    this->setAbsoluteError(rule.absoluteError());
