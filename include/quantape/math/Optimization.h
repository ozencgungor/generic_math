 ...
 * `Optimizer<DoubleT, Impl>` CRTP base, the shared strong-Wolfe line search
 ...
 * "Math/Optimization/OptimizerStanPrimitives.h" — or "Math/StanPrimitives.h"
 ...
 * "Math/Optimization/ImplicitFunction.h" (Stan-dependent, like
