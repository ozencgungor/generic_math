 ...
 *
 * Usage:
 *   `#include "quantape/math/Integrals.h"`
 ...
 * "quantape/math/Integrals/IntegratorStanPrimitives.h" — or the single AD umbrella
 * "quantape/math/StanPrimitives.h" — and the integrators use the optimized one-pass
