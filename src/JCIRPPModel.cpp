#include "quantape/models/JCIRPPModel.h"
...
JCIRPPModel::JCIRPPModel(const JCIRPPParams& params) : m_params(params) {}

void JCIRPPModel::update(JCIRPPState& current, const JCIRPPState& previous, size_t stepIndex,
    ...
    double prevShift =
        (stepIndex - 1 < m_params.shifts.size()) ? m_params.shifts[stepIndex - 1] : 0.0;
