...
struct IRVolDescriptor {
     ...
     */
    IRVolDescriptor()
        : currency("USD"), volType("SWAPTION"), referenceDate(""), index("") {}

    /**
     * @brief Constructor with all fields
     */
    IRVolDescriptor(const std::string& ccy, const std::string& type,
                    const std::string& refDate, const std::string& idx = "")
    ...
    std::string identifier() const {
        return currency + "." + volType + "." + referenceDate;
    }
};
